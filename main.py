...
def on_update_interval():
    ...
    Enemy1.y = randint(10, scene.screen_height() - 0)
...
def on_update_interval2():
    ...
    enemy2.y = randint(10, scene.screen_height() - 0)
game.on_update_interval(randint(2000, 10000), on_update_interval2)
